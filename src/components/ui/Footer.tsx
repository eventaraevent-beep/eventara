...
export function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-b from-rich-black to-burgundy-dark border-t border-event-gold/20">
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-16">
                    ...
                    {LOCATIONS.slice(0, 4).map((location) => (
                      <li key={`${service.slug}-${location.slug}`}>
                        <Link
                          ...
                          className="font-inter text-cream-light/70 hover:text-event-gold transition-colors text-sm"
        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              <a href="#" className="text-event-gold hover:text-light-gold" title="Follow us on Facebook" aria-label="Follow us on Facebook">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                </svg>
              </a>
              <a href="#" className="text-event-gold hover:text-light-gold" title="Follow us on Instagram" aria-label="Follow us on Instagram">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#" className="text-event-gold hover:text-light-gold" title="Follow us on LinkedIn" aria-label="Follow us on LinkedIn">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <span className="font-inter text-cream-light/50 text-sm">
                  +3 more regions
                </span>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 font-inter text-sm text-cream-light/70">
              <li>
                <a
        ...
        {/* Bottom Footer */}
        <div className="flex flex-col md:flex-row items-center justify-between font-inter text-sm text-cream-light/70">
