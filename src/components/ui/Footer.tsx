        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              <a href="https://www.facebook.com/profile.php?id=61577290076145" target="_blank" rel="noopener noreferrer" className="text-event-gold hover:text-light-gold" title="Follow us on Facebook" aria-label="Follow us on Facebook">
