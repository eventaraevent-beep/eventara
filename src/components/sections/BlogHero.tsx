    ...
    <section className="relative min-h-[400px] pt-20 flex items-center bg-rich-black overflow-hidden">
      ...
      >
        <h1 className="font-playfair text-6xl md:text-7xl font-bold mb-6 text-white">
          Event <span className="text-gradient">Insights & Tips</span>
        </h1>
        <p className="font-inter text-xl text-cream-light/90 max-w-2xl mx-auto">
          Expert advice for planning your perfect celebration
        </p>
      </motion.div>
    </section>
  );
